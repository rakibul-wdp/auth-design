...
function App() {
  ...
  return (
    <div className='w-[80vw] h-[80vh] bg-white shadow-lg rounded-2xl flex items-center justify-around'>
      <div className=''>
        <div className='mt-[-3rem] mb-16 lg:ml-[-15rem] xl:ml-[-23rem] 2xl:ml-[-25rem] flex items-center justify-around'>
          <img className='' src={LogoImage} alt="me" width="50" height="50" />
      ...
      <div className='hidden sm:hidden md:hidden lg:block xl:block 2xl:block'>
        <img src={AuthImage} alt="me" width="500" height="500" />
      </div>
    </div>
  );
}
